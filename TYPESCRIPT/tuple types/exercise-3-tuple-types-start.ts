...
type CountryWithCurrency = [string, string, string]; // Tuple type with specific element types
...
// This will cause a type error because you can't modify a readonly tuple.
